...
- The screenshot of a demo is `demos/<demoname>-gtk3.png` or `demos/<demoname>-gtk4.png`. It holds the window of `gtk3-demo --run=<demoname>` or of `gtk4-demo --demo=<demoname>`. The fix overwrites the same file, thus each file shows the demo of today and Git holds the history of the fixes.
